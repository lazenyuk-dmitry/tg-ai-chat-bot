...
- **Monitoring:** [Uptimerobot](https://uptimerobot.com/) (by keywords) с отправкой уведомлений в приватный Discord канал
...
DB_PORT=5432
HEALTH_PORT=8000
DB_ECHO=False # логирование запросов к базе в консоль
```
